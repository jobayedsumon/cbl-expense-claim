<div class="modal fade" id="editExpenseClaimModal" tabindex="-1" role="dialog" aria-labelledby="editExpenseClaimModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">

            <form autocomplete="off" id="editExpenseClaimModalForm" method="POST" action="excs/advance_information_store">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="form-group">
                                ...
                                <input step=".01" type="number" class="form-control editModalCalculation" min="1" id="editRate" value="1" name="RATE" required>
                            </div>
                        </div>
                    </div>
