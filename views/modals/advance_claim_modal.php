...
<!-- Advance Claim Modal -->
<div class="modal fade" id="advanceClaimModal" tabindex="-1" role="dialog" aria-labelledby="advanceClaimModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form autocomplete="off" id="advanceInformationModalForm" method="POST" action="excs/advance_information_store">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="form-group">
                                ...
                                <input step=".01" type="number" class="form-control modalCalculation" min="1.00" value="1.00" name="RATE" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6">
                            <div class="form-group">
                                ...
                                <input readonly type="number" step="0.01" class="form-control" min="1.00" value="1.00" id="totalAmount">
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 bdtInfo">
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Total Amount(BDT)</label>
                                <input readonly type="number" step="0.01" class="form-control" min="1.00" value="1.00" id="totalAmountBDT">
                            </div>
                        </div>
                    </div>
