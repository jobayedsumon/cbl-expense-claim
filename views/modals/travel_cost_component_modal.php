<div class="modal fade" id="travelCostComponentModal" tabindex="-1" role="dialog" aria-labelledby="travelCostComponentModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form autocomplete="off" id="travelCostComponentModalForm" method="POST" >
...
<!--                    </table>-->
                ...
                <input type="hidden" id="totalTravelAmount" value="<?php echo $travel_plan->plan->projected_amount_bdt; ?>">
