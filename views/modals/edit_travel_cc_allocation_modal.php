<div class="modal fade" id="editTravelCcAllocationModal" tabindex="-1" role="dialog" aria-labelledby="editTravelCcAllocationModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form autocomplete="off" id="editTravelCcAllocationModalForm" method="POST" >
...
<!--                    </table>-->
                ...
                <input type="hidden" id="ccAllocationId" value="">
